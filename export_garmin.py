...
# Version Info
print("")
print("Mi Body Composition Scale 2 Garmin Connect v4.2 (export_garmin.py)")
print("")
...
if selected_user is not None:
	...
	print("* Calculated data: " + "{:.2f}".format(lib.getBoneMass()) + ";{:.2f}".format(lib.getBMI()) + ";{:.2f}".format(lib.getFatPercentage()) + ";{:.2f}".format(lib.getWaterPercentage()) + ";{:.0f}".format(lib.getMetabolicAge()) + ";{:.2f}".format(lib.getMuscleMass()) + ";{:.2f}".format(lib.getBodyType()) + ";{:.2f}".format(lib.getVisceralFat()) + datetime.datetime.now().strftime(";%Y-%m-%d %H:%M:%S"))
else:
